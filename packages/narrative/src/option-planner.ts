    ...
    messages: [
      { role: 'system', content: context.systemRules },
      {
        ...
        content: [
          ...
          '输出 JSON 数组，元素结构：',
          '{"id":"option_001","behavior":{"actions":["support"],"intent":["care"],"risk":0.15},"gameplay":{"progress":2},"effects":{"affection":{"base":2}},"conditions":{},"generation":{"must_fit_character":true,"must_fit_context":true,"variation":"high"}}',
        ].join('\n'),
      },
    ],
  };
